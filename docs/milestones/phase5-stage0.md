...
- 整体架构文档 `phase5-autonomy.md`
- 数据流图（mermaid）
- 存储布局 `phase5-storage.md`
- 算法伪代码 `phase5-algorithms.md`
- 风险分析 `phase5-risk-analysis.md`
- 4 份 ADR（015-018）：ExecutionReplay / StructuredReview / ABPromotion / DAGSMode
