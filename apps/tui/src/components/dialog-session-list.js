  ...
  const items = useMemo(() => {
    ...
    const buildOption = (id, category) => {
      ...
      const prefix = isWorking
        ? _jsx(Text, { color: "green", children: _jsx(Spinner, { type: "dots" }) })
        : slot !== undefined
          ? _jsx(Text, { color: "cyan", children: slot })
          : undefined
      return {
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, children: t("tui.sessions") }),
          ...
          itemComponent: ({ isSelected, label, value, prefix }) =>
            _jsxs(Box, {
              ...
              children: [
                ...
                _jsx(Text, { children: " " }),
                _jsx(Text, {
                  color: isSelected ? "green" : toDelete === value ? "red" : undefined,
                  children: label,
                }),
              ],
            }),
      ...
      footerHints.length > 0 &&
        _jsx(Box, {
          marginTop: 1,
          children: footerHints.map((h) =>
            _jsxs(Text, { dimColor: true, children: [h.title, ": ", h.label] }, h.title),
          ),
        }),
    ],
  })
