...
export function DialogWorkspaceSelect(props) {
  ...
  if (!adapters) return _jsx(Text, { dimColor: true, children: "Loading adapters..." })
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, children: view === "main" ? "Warp" : "Existing Workspace" }),
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        justifyContent: "space-between",
        children: [
          _jsx(Text, { bold: true, children: t("tui.createWorkspace") }),
          _jsx(Text, { dimColor: true, children: "esc" }),
        ],
      }),
      _jsxs(Box, {
