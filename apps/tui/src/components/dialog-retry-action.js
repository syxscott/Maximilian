  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, color: theme.text, children: props.title }),
          _jsx(Text, { color: theme.textMuted, children: "esc" }),
        ],
      }),
      _jsx(Box, {
        marginTop: 1,
        children: _jsx(Text, { color: theme.textMuted, children: props.message }),
      }),
      props.link
        ? _jsx(Box, {
            width: "100%",
...
DialogRetryAction.show = (dialog, props) => {
  return new Promise((resolve) => {
    dialog.replace(
      _jsx(DialogRetryAction, { ...props, onClose: (dontShow) => resolve(dontShow ?? false) }),
