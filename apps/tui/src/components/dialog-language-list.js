  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, children: t("tui.language") }),
          _jsx(Text, { dimColor: true, children: t("tui.esc") }),
        ],
      }),
      _jsx(Box, {
        marginTop: 1,
      ...
      active
        ? _jsx(Box, { marginTop: 1, children: _jsx(Text, { dimColor: true, children: active }) })
        : null,
    ],
  })
}
