...
export function DialogModel(props) {
  ...
  const items = useMemo(() => {
    ...
    const sortedProvider = sortModelOptions(providerOptions, props.providerID !== undefined).map(
      (opt) => {
            ...
            _jsxs(Box, {
              ...
              children: [
                ...
                props.current?.providerID === value.providerID &&
                  props.current?.modelID === value.modelID &&
                  _jsx(Text, { dimColor: true, children: " (current)" }),
              ],
            }),
        }),
      }),
