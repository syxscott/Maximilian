...
function Status(props) {
  if (props.loading) return _jsx(Text, { dimColor: true, children: "... Loading" })
  if (props.enabled) return _jsxs(Text, { color: "green", bold: true, children: ["✓", " Enabled"] })
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, children: t("tui.mcps") }),
              ...
              children: [
                _jsxs(Box, {
                  ...
                  children: [
                    ...
                    description && _jsxs(Text, { dimColor: true, children: ["  ", description] }),
                  ],
                }),
                _jsx(Box, { children: footer }),
                _jsxs(Text, { dimColor: true, children: [actions[0]?.title, " [", value, "]"] }),
              ],
            }),
        }),
      }),
