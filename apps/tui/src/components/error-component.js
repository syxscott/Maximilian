  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        alignItems: "center",
        children: [
          _jsx(Text, { bold: true, color: colors.text, children: "Please report an issue." }),
          _jsx(Box, {
            borderStyle: "single",
            ...
            children: _jsx(Text, {
              bold: true,
              color: colors.text,
              children: "Copy issue URL (exception info pre-filled)",
            }),
          }),
          copied
            ? _jsx(Text, { color: colors.muted, children: t("tui.copiedSuccessfully") })
            : null,
        ],
      }),
      _jsxs(Box, {
        ...
        alignItems: "center",
        children: [
          _jsx(Text, { color: colors.text, children: "A fatal error occurred!" }),
          _jsx(Box, {
            borderStyle: "single",
            borderColor: colors.primary,
            paddingLeft: 1,
            paddingRight: 1,
            children: _jsx(Text, { color: colors.text, children: t("tui.resetTui") }),
          }),
          _jsx(Box, {
            borderStyle: "single",
            borderColor: colors.primary,
            paddingLeft: 1,
            paddingRight: 1,
            children: _jsx(Text, { color: colors.text, children: t("tui.exit") }),
          }),
        ],
      }),
      _jsx(Box, {
        ...
        children: _jsx(Text, {
          color: colors.muted,
          wrap: "wrap",
          children: error.stack ?? "(no stack trace)",
        }),
      }),
      _jsx(Text, { color: colors.text, children: error.message }),
      _jsx(Text, { dimColor: true, children: issueURL.toString().slice(0, 80) }),
    ],
  })
}
