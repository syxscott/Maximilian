  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, children: props.title ?? "File Changes Found" }),
      ...
      _jsx(Box, {
        children: _jsx(Text, {
          dimColor: true,
          wrap: "word",
          children: props.message ?? "Do you want to move these changes with the session?",
        }),
      }),
      _jsx(Box, {
        flexDirection: "column",
                ...
                _jsxs(Box, {
                  ...
                  children: [
                    _jsx(Box, {
                      width: 2,
                      flexShrink: 0,
                      children: _jsx(Text, { dimColor: true, children: statusLabel(item.status) }),
                    }),
                    _jsx(Text, {
                      dimColor: true,
                      wrap: "none",
                      children: truncateLeft(item.file, fileNameWidth),
                    }),
                  ],
                }),
                _jsx(Box, {
                  ...
                  children: _jsxs(Text, {
                    children: [
                      item.additions
                        ? _jsxs(Text, { color: "green", children: ["+", item.additions] })
                        : null,
                      item.deletions
                        ? _jsxs(Text, { color: "red", children: [" -", item.deletions] })
                        : null,
                    ],
                  }),
                }),
      ...
      _jsx(Box, {
        ...
        children: OPTIONS.map((item) =>
          _jsx(
            ...
            {
              paddingX: 2,
              backgroundColor: item === active ? "blue" : undefined,
              children: _jsx(Text, {
