  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, children: t("tui.skills") }),
      ...
      _jsxs(Box, {
        marginY: 1,
        children: [
          _jsx(Text, { children: "Search: " }),
          _jsx(TextInput, { value: query, onChange: setQuery, placeholder: "Search skills..." }),
        ],
      }),
      _jsx(Box, {
        children: loading
          ? _jsx(Text, { dimColor: true, children: "Loading skills..." })
          : _jsx(SelectInput, {
              items: filtered,
              onSelect: (item) => {
