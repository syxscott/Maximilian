  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, color: theme.text, children: "Failed to Delete Session" }),
      ...
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, {
            ...
            wrap: "wrap",
            children: `The session "${props.session}" could not be deleted because the workspace "${props.workspace}" is not available.`,
          }),
          _jsx(Text, {
            color: theme.textMuted,
            wrap: "wrap",
            children: "Choose how you want to recover this broken workspace session.",
          }),
        ],
      }),
      _jsx(Box, {
