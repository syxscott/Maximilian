  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, children: t("tui.exportOptions") }),
      ...
      _jsxs(Box, {
        marginY: 1,
        children: [
          _jsx(Text, { children: "Format: " }),
          _jsx(Text, { color: "cyan", children: format }),
        ],
      }),
      view === "format"
        ? _jsxs(Box, {
            ...
            children: [
              _jsx(Box, {
                marginBottom: 1,
                children: _jsx(Text, { dimColor: true, children: t("tui.chooseAFormat") }),
              }),
              _jsx(SelectInput, {
                items: formatItems,
                onSelect: (item) => {
                ...
                itemComponent: ({ isSelected, label, value }) =>
                  _jsxs(Box, {
                    ...
                    children: [
                      ...
                      value === format && _jsx(Text, { dimColor: true, children: " (current)" }),
                    ],
                  }),
              }),
            ],
