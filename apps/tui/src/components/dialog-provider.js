  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, children: t("tui.connectAProvider") }),
      ...
      _jsx(Box, {
        ...
        children: _jsx(SelectInput, {
          ...
          itemComponent: ({ isSelected, label }) =>
            _jsx(Text, { color: isSelected ? "green" : undefined, children: label }),
        }),
      }),
    ],
  })
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        justifyContent: "space-between",
        children: [
          _jsx(Text, { bold: true, children: props.title }),
          _jsx(Text, { dimColor: true, children: "esc" }),
        ],
      }),
      _jsxs(Box, {
        ...
        gap: 1,
        children: [
          _jsx(Text, { color: "blue", children: props.authorization.url }),
          _jsx(Text, { dimColor: true, children: props.authorization.instructions }),
        ],
      }),
      _jsxs(Text, { dimColor: true, children: ["Waiting for authorization... ", tick, "s"] }),
      _jsx(Box, {
        children: _jsxs(Text, {
          children: ["c ", _jsx(Text, { dimColor: true, children: "copy" })],
        }),
      }),
    ],
  })
    ...
    children: [
      ...
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { dimColor: true, children: props.authorization.instructions }),
          _jsx(Text, { color: "blue", children: props.authorization.url }),
          error && _jsx(Text, { color: "red", children: t("tui.invalidCode") }),
        ],
      }),
      _jsxs(Box, {
        children: [
          _jsx(Text, { children: "Code: " }),
          _jsx(TextInput, {
            value: code,
            onChange: setCode,
...
export function ApiMethod(props) {
  ...
  return _jsxs(Box, {
    ...
    children: [
      ...
      props.description ? _jsx(Box, { children: props.description }) : null,
      _jsxs(Box, {
        children: [
          _jsx(Text, { children: "API key: " }),
          _jsx(TextInput, {
            value: value,
            onChange: setValue,
            onSubmit: (v) => {
...
export function DialogPrompt(props) {
  ...
  if (props.options && props.options.length > 0) {
    return _jsxs(Box, {
      ...
      children: [
        ...
        props.description && _jsx(Box, { marginY: 1, children: props.description }),
        _jsx(Box, {
          marginTop: 1,
          children: _jsx(SelectInput, {
  ...
  return _jsxs(Box, {
    ...
    children: [
      ...
      _jsxs(Box, {
        children: [
          _jsxs(Text, { children: [props.placeholder ?? "Value", ": "] }),
          _jsx(TextInput, {
            value: value,
            onChange: setValue,
