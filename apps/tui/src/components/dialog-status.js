  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, children: t("tui.status") }),
          _jsx(Text, { dimColor: true, children: "esc" }),
        ],
      }),
      showMcp
        ? _jsxs(Box, {
            flexDirection: "column",
            children: [
              _jsxs(Text, { children: [mcpEntries.length, " MCP Servers"] }),
                  ...
                  Box,
                  {
                    ...
                    children: [
                      ...
                      _jsxs(Text, {
                        wrap: "word",
                        children: [
                          _jsx(Text, { bold: true, children: key }),
                          " ",
                          _jsx(Text, { dimColor: true, children: mcpStatusText(key, item) }),
                        ],
                      }),
                    ],
                  },
        ...
        : _jsx(Text, { children: t("tui.noMcpServers") }),
      showLsp &&
        _jsxs(Box, {
          flexDirection: "column",
          children: [
            _jsxs(Text, { children: [props.lsps.length, " LSP Servers"] }),
            props.lsps.map((item) =>
              _jsxs(
                Box,
                {
                  ...
                  children: [
                    ...
                    _jsxs(Text, {
                      wrap: "word",
                      children: [
                        _jsx(Text, { bold: true, children: item.id }),
                        " ",
                        _jsx(Text, { dimColor: true, children: item.root }),
                      ],
                    }),
                  ],
                },
      ...
      showFormatters
        ? _jsxs(Box, {
            flexDirection: "column",
            children: [
              _jsxs(Text, { children: [enabledFormatters.length, " Formatters"] }),
              enabledFormatters.map((item) =>
                _jsxs(
                  Box,
                  {
                    ...
                    gap: 1,
                    children: [
                      _jsx(Text, { color: "green", flexShrink: 0, children: "\u2022" }),
                      _jsx(Text, { wrap: "word", bold: true, children: item.name }),
                    ],
                  },
                  item.name,
                ),
        ...
        : _jsx(Text, { children: t("tui.noFormatters") }),
      showPlugins
        ? _jsxs(Box, {
            flexDirection: "column",
            children: [
              _jsxs(Text, { children: [plugins.length, " Plugins"] }),
              plugins.map((item) =>
                _jsxs(
                  Box,
                  {
                    ...
                    children: [
                      ...
                      _jsxs(Text, {
                        wrap: "word",
                        children: [
                          _jsx(Text, { bold: true, children: item.name }),
                          item.version &&
                            _jsxs(Text, { dimColor: true, children: [" @", item.version] }),
                        ],
                      }),
                    ],
                  },
        ...
        : _jsx(Text, { children: t("tui.noPlugins") }),
    ],
  })
}
