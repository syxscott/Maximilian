...
export function Tips(props) {
  ...
  return _jsxs(Box, {
    ...
    maxWidth: "100%",
    children: [
      _jsx(Text, { color: theme.warning, flexShrink: 0, children: "● Tip " }),
      _jsx(Text, {
        flexShrink: 1,
        wrap: "word",
        children: parts.map((part, index) =>
          _jsx(
            Text,
            { color: part.highlight ? theme.text : theme.textMuted, children: part.text },
            index,
          ),
        ),
      }),
...
const TERMINAL_SUSPEND_TIP = (shortcuts) =>
