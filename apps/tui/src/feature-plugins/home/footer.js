  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Text, {
        ...
        children: [
          _jsx(Text, {
            color: err ? theme.error : count > 0 ? theme.success : theme.textMuted,
            children: "⊙ ",
          }),
          count,
          " MCP",
      ...
      _jsx(Text, { color: theme.textMuted, children: "/status" }),
    ],
  })
}
function Version(props) {
  ...
  return _jsx(Box, {
    flexShrink: 0,
    children: _jsx(Text, { color: theme.textMuted, children: props.api.app.version }),
  })
}
function View(props) {
  return _jsxs(Box, {
    ...
    gap: 2,
    children: [
      _jsx(Directory, { api: props.api }),
      _jsx(Mcp, { api: props.api }),
      _jsx(Box, { flexGrow: 1 }),
      _jsx(Version, { api: props.api }),
    ],
  })
}
const tui = async (api) => {
