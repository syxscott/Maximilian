...
function View(props) {
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsx(Text, { color: theme.text, bold: true, children: "Context" }),
      _jsxs(Text, { color: theme.textMuted, children: [state.tokens.toLocaleString(), " tokens"] }),
      _jsxs(Text, { color: theme.textMuted, children: [state.percent ?? 0, "% used"] }),
      _jsxs(Text, { color: theme.textMuted, children: [money.format(cost), " spent"] }),
    ],
  })
}
const tui = async (api) => {
