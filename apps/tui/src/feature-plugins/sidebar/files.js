  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          list.length > 2 && _jsx(Text, { color: theme.text, children: open ? "▼" : "▶" }),
          _jsx(Text, { color: theme.text, bold: true, children: "Modified Files" }),
        ],
      }),
      (list.length <= 2 || open) &&
        list.map((item, index) =>
            ...
            Box,
            {
              ...
              children: [
                ...
                _jsxs(Box, {
                  ...
                  children: [
                    item.additions > 0 &&
                      _jsxs(Text, { color: theme.diffAdded, children: ["+", item.additions] }),
                    item.deletions > 0 &&
                      _jsxs(Text, { color: theme.diffRemoved, children: ["-", item.deletions] }),
                  ],
                }),
              ],
            },
