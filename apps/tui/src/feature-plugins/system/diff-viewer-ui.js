...
export function PanelGroup(props) {
  ...
  return _jsx(PanelGroupContext.Provider, {
    value: { axis },
    children: _jsx(Box, {
      minWidth: 0,
      minHeight: 0,
...
export function Separator(props) {
  ...
  if (axis === "y") {
    if (props.start || props.end) {
      return _jsxs(Box, {
        ...
        children: [
          props.start && _jsx(Text, { color: color, children: verticalEdge(props.start, "start") }),
          _jsx(Box, { flexGrow: 1, borderLeft: true, borderColor: color }),
          props.end && _jsx(Text, { color: color, children: verticalEdge(props.end, "end") }),
        ],
      })
    }
  ...
  if (props.start || props.end) {
    return _jsxs(Box, {
      ...
      flexDirection: "row",
      children: [
        props.start && _jsx(Text, { color: color, children: horizontalEdge(props.start, "start") }),
        _jsx(Box, { flexGrow: 1, borderTop: true, borderColor: color }),
        props.end && _jsx(Text, { color: color, children: horizontalEdge(props.end, "end") }),
      ],
    })
  }
