...
function DiffViewer(props) {
  ...
  const [fileTreeEnabled, setFileTreeEnabled] = useState(
    props.api.kv.get(KV_SHOW_FILE_TREE, true) !== false,
  )
  const showFileTreeVal = useMemo(
    () => showDiffViewerFileTree(fileTreeEnabled, files.length),
    [fileTreeEnabled, files],
  )
  const [singlePatch, setSinglePatch] = useState(props.api.kv.get(KV_SINGLE_PATCH, false) === true)
  const patchPaneWidth = useMemo(
    () => terminalWidth - (showFileTreeVal ? 33 : 0) - 4,
    [terminalWidth, showFileTreeVal],
  )
  ...
  const view = useMemo(
    () => (splitAvailable ? (viewOverride ?? defaultView) : "unified"),
    [splitAvailable, viewOverride, defaultView],
  )
  ...
  const fileRows = useMemo(
    () => flattenFileTree(fileTree, expandedFileNodes),
    [fileTree, expandedFileNodes],
  )
      ...
      try {
        if (diffInput.mode === "last-turn") {
          ...
          const result = await props.api.client.vcs.diff(
            {
              directory: diffInput.directory,
              mode: "git",
              context: WORKING_TREE_DIFF_CONTEXT_LINES,
            },
            { throwOnError: true },
          )
          if (!cancelled) {
  ...
  const moveFileSelection = useCallback(
    (offset) => setHighlighted(moveFileTreeSelection(fileRows, highlightedFileNode, offset)),
    ...
    children: _jsxs(PanelGroup, {
      ...
      children: [
        _jsxs(Panel, {
          ...
          paddingLeft: 1,
          children: [
            _jsx(Text, { color: theme.text, children: "Diff " }),
            _jsx(Text, {
              color: theme.textMuted,
              children: mode === "last-turn" ? "last turn" : "working tree",
            }),
            _jsx(Box, { flexGrow: 1 }),
            _jsxs(Text, {
              color: theme.textMuted,
        ...
        _jsx(Box, {
          flexGrow: 1,
          minHeight: 0,
          children: diffLoading
            ? _jsxs(_Fragment, {
                children: [
                  _jsx(Separator, { axis: "x" }),
                  _jsx(Box, {
                    flexGrow: 1,
                    paddingLeft: 1,
                    children: _jsx(Text, { color: theme.textMuted, children: "Loading diff..." }),
                  }),
                ],
              })
              ...
              ? _jsxs(_Fragment, {
                  children: [
                    ...
                    _jsx(Box, {
                      flexGrow: 1,
                      paddingLeft: 1,
                      children: _jsx(Text, { color: theme.textMuted, children: "No diff!" }),
                    }),
                  ],
                })
                      ...
                      children: [
                        ...
                        _jsxs(Panel, {
                          ...
                          children: [
                            _jsx(Separator, {
                              axis: "x",
                              start: showFileTreeVal ? "edge-out" : undefined,
                            }),
                            _jsxs(Box, {
                              ...
                              children: [
                                    ...
                                    Box,
                                    {
                                      ...
                                      children: [
                                        index !== 0 &&
                                          _jsx(Separator, {
                                            axis: "x",
                                            start: showFileTreeVal ? "edge" : undefined,
                                          }),
                                        _jsxs(Box, {
                                          flexDirection: "row",
                                          gap: 1,
                                          ...
                                          children: [
                                            _jsx(Text, {
                                              color: reviewed ? theme.textMuted : theme.text,
                                              children: entry.file.file,
                                            }),
                                            _jsx(Box, { flexGrow: 1 }),
                                            _jsxs(Text, {
                                              color: reviewed ? theme.textMuted : theme.diffAdded,
                                              children: ["+", entry.file.additions],
                                            }),
                                            _jsxs(Text, {
                                              color: reviewed ? theme.textMuted : theme.diffRemoved,
                                              children: ["-", entry.file.deletions],
                                            }),
                                          ],
                                        }),
                                        _jsx(Separator, {
                                        ...
                                        entry.file.patch
                                          ? _jsx(Box, {
                                              children: _jsx(Text, {
                                                color: reviewed ? theme.textMuted : theme.text,
                                                wrap: "word",
                                                children: entry.file.patch,
                                              }),
                                            })
                                          : _jsx(Text, {
                                              color: theme.textMuted,
                                              children: "No patch available for this file.",
                                            }),
                                      ],
                                    },
                                    entry.fileIndex,
                                ...
                                patchFillerHeight > 0 && _jsx(Box, { height: patchFillerHeight }),
                              ],
                            }),
                            _jsx(Separator, {
                              axis: "x",
                              start: showFileTreeVal ? "edge-in" : undefined,
                            }),
                          ],
                        }),
                      ],
            ...
            switchFocusShortcut() &&
              _jsxs(Text, {
                ...
                children: [
                  switchFocusShortcut(),
                  " ",
                  _jsx(Text, { color: theme.textMuted, children: "focus file tree" }),
                ],
              }),
            nextFileShortcut() &&
              _jsxs(Text, {
                ...
                children: [
                  nextFileShortcut(),
                  " ",
                  _jsx(Text, { color: theme.textMuted, children: "next file" }),
                ],
              }),
            nextHunkShortcut() &&
              _jsxs(Text, {
                ...
                children: [
                  nextHunkShortcut(),
                  " ",
                  _jsx(Text, { color: theme.textMuted, children: "next hunk" }),
                ],
              }),
            previousHunkShortcut() &&
              _jsxs(Text, {
                ...
                children: [
                  previousHunkShortcut(),
                  " ",
                  _jsx(Text, { color: theme.textMuted, children: "previous hunk" }),
                ],
              }),
            previousFileShortcut() &&
              _jsxs(Text, {
                ...
                children: [
                  previousFileShortcut(),
                  " ",
                  _jsx(Text, { color: theme.textMuted, children: "previous file" }),
                ],
              }),
            switchSourceShortcut() &&
              _jsxs(Text, {
                ...
                children: [
                  switchSourceShortcut(),
                  " ",
                  _jsx(Text, { color: theme.textMuted, children: "switch source" }),
                ],
              }),
            markReviewedShortcut() &&
              _jsxs(Text, {
                ...
                children: [
                  markReviewedShortcut(),
                  " ",
                  _jsx(Text, { color: theme.textMuted, children: "mark reviewed" }),
                ],
              }),
            helpShortcut() &&
              _jsxs(Text, {
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Text, { bold: true, color: theme.text, children: "Diff shortcuts" }),
          _jsx(Text, { color: theme.textMuted, children: "esc" }),
        ],
      }),
      _jsxs(Box, {
        flexDirection: "row",
        children: [
          _jsx(Text, { color: theme.textMuted, width: 5, wrap: "truncate-end", children: "Key" }),
          _jsx(Text, {
            color: theme.textMuted,
            width: 22,
            wrap: "truncate-end",
          ...
          _jsx(Text, { color: theme.textMuted, children: "Description" }),
        ],
      }),
      rows.map((row, index) =>
        _jsxs(
          Box,
          {
            ...
            children: [
              ...
              _jsx(Text, { color: theme.textMuted, children: row.description }),
            ],
          },
          index,
        ),
