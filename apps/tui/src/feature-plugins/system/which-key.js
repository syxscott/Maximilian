  ...
  return _jsx(Box, {
    ...
    children: _jsxs(Text, {
      ...
      children: [
        ...
        _jsx(Text, { color: look.subtle, children: trigger() || command.toggle }),
      ],
    }),
  })
}
    ...
    children: [
      headerVisible &&
        _jsx(Box, {
          ...
          gap: tabGap,
          flexShrink: 0,
          children: headerItems.map((item, index) => {
            if (item.type === "scroll") {
              return _jsx(
                Box,
                {
                  ...
                  children: _jsxs(Text, {
                    wrap: "truncate-end",
                    children: [
                      _jsx(Text, { color: upActive ? look.text : look.muted, children: "↑" }),
                      _jsx(Text, { color: look.muted, children: " " }),
                      _jsx(Text, { color: downActive ? look.text : look.muted, children: "↓" }),
                    ],
                  }),
                },
                `scroll-${index}`,
      ...
      tabsVisible && _jsx(Box, { height: TAB_CONTENT_GAP, flexShrink: 0 }),
      _jsx(Box, {
        height: rows,
        flexShrink: 0,
        flexDirection: "column",
        children:
          shown.length === 0
            ? _jsx(Text, { color: look.muted, children: "No reachable bindings" })
            : rowIndexes.map((row) =>
                _jsx(
                  Box,
                  {
                    ...
                    justifyContent: "center",
                    gap: COLUMN_GAP,
                    children: shown.map((column, colIndex) => {
                      const item = column[row]
                      if (!item) return _jsx(Box, { width: columnWidth }, colIndex)
                      if (item.type !== "entry") {
                        return _jsx(
                          Box,
                          {
                        ...
                        Box,
                        {
                          ...
                          children: [
                            _jsx(Box, {
                              ...
                              minWidth: 0,
                              children: _jsx(Text, {
                                color: binding.continues ? look.accent : look.muted,
                                wrap: "truncate",
      ...
      footerVisible &&
        _jsxs(_Fragment, {
          children: [
            _jsx(Box, { height: FOOTER_MARGIN, flexShrink: 0 }),
            _jsxs(Box, {
              width: "100%",
              flexDirection: "row",
              justifyContent: "space-between",
                ...
                _jsx(Box, {
                  children: _jsxs(Text, {
                    ...
                    children: [
                      ...
                      _jsx(Text, {
                        color: look.subtle,
                        children: modeTrigger() || command.toggleLayout,
                      }),
                    ],
                  }),
                }),
