...
const en: Dict = {
  ...
  "tui.usage.window24h": "24h window",
  ...
  "tui.agents.detail.topScores": "review score top 3",
  "tui.agents.detail.promotions": "version promotions",
  "tui.agents.noScores": "no review decisions recorded yet",
  "tui.agents.noScoreHistory": "no review score history yet",
  ...
  "tui.memory.efficacy.filter.all": "all",
  "tui.memory.efficacy.filter.skipOnly": "skip-only",
  "tui.memory.efficacy.filter.injectOnly": "inject-only",
  "tui.memory.efficacy.filter.empty": "no buckets match this filter",
...
const zh: Dict = {
  ...
  "tui.agents.detail.topScores": "评审分数 top 3",
  "tui.agents.detail.promotions": "版本晋升",
  "tui.agents.noScores": "还没有评审决策记录",
  "tui.agents.noScoreHistory": "暂无评分历史",
  ...
  "tui.memory.hints.role":
    "j/k 移动 · Enter 展开 · b 返回角色 · e 导出 · f 过滤 · r 刷新 · esc 关闭",
  ...
  "tui.memory.efficacy.filter.all": "全部",
  "tui.memory.efficacy.filter.skipOnly": "仅门控",
  "tui.memory.efficacy.filter.injectOnly": "仅注入",
  "tui.memory.efficacy.filter.empty": "该过滤条件下没有桶",
