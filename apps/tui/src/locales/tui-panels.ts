...
const en: Dict = {
  ...
  "tui.jobs.materializedHint": "materialized → {id}",
  "tui.jobs.materializedFailed": "no workspace (failed)",
  "tui.jobs.copied": "Workspace {id} copied to clipboard",
  "tui.jobs.copyFailed": "Copy failed: {error}",
  "tui.jobs.copyUnavailable": "clipboard unavailable",
  "tui.jobs.nothingMaterialized": "No materialized workspace yet — trigger the job first",
...
const zh: Dict = {
  ...
  "tui.jobs.hints": "j/k 移动 · Enter 详情 · d 删除 · t 触发 · c 复制工作区 · r 刷新 · esc 关闭",
  "tui.jobs.materializedHint": "已物化 → {id}",
  "tui.jobs.materializedFailed": "无工作区（失败）",
  "tui.jobs.copied": "工作区 {id} 已复制到剪贴板",
  "tui.jobs.copyFailed": "复制失败：{error}",
  "tui.jobs.copyUnavailable": "剪贴板不可用",
  "tui.jobs.nothingMaterialized": "还没有物化的工作区——先触发一次任务",
  "tui.jobs.details": "详情",
  "tui.jobs.payload": "负载",
