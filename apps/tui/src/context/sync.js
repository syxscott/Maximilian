        ...
        async function bootstrap(input = {}) {
            ...
            bootstrapRef.current = (async () => {
                try {
                    ...
                    await Promise.all([
                        sdk.client.get(`/config/providers?workspace=${encodeURIComponent(workspace)}`).catch(() => null),
                        sdk.client.get(`/provider/list?workspace=${encodeURIComponent(workspace)}`).catch(() => null),
                        sdk.client.get(`/app/agents?workspace=${encodeURIComponent(workspace)}`).catch(() => null),
                    ]);
                }
                catch (err) {
