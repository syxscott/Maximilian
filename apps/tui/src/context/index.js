...
const { Provider: PluginRuntimeProvider, use: usePluginRuntime } = makeStubProvider(
  "PluginRuntime",
  pluginRuntimeImpl,
)
...
const { Provider: PromptRefProvider, use: usePromptRef } = makeStubProvider("PromptRef", {
  current: null,
})
