...
function EditBody(props) {
  ...
  return _jsx(Box, {
    ...
    children: diff
      ? _jsx(Box, { paddingLeft: 1, children: _jsx(Text, { color: theme.text, children: diff }) })
      : _jsx(Box, {
          paddingLeft: 1,
          children: _jsx(Text, { dimColor: true, children: "No diff provided" }),
        }),
  })
}
// ---------------------------------------------------------------------------
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        paddingLeft: 1,
        children: [
          props.icon ? _jsx(Text, { dimColor: true, children: props.icon }) : null,
          _jsx(Text, { dimColor: true, children: props.title }),
        ],
      }),
      props.description
        ? _jsx(Box, {
            paddingLeft: 1,
            children: _jsx(Text, { color: theme.text, children: props.description }),
          })
        : null,
    ],
  })
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        ...
        paddingLeft: 1,
        children: [
          _jsx(Text, { color: theme.error, children: "!" }),
          _jsx(Text, { color: theme.text, children: "Reject permission" }),
        ],
      }),
      _jsx(Box, {
        paddingLeft: 1,
        children: _jsx(Text, { dimColor: true, children: "Tell OpenCode what to do differently" }),
      }),
      _jsx(Box, {
        paddingLeft: 1,
        paddingTop: 1,
        children: _jsxs(Text, {
          color: theme.text,
          children: [value, _jsx(Text, { color: theme.primary, children: "_" })],
        }),
      }),
      _jsxs(Box, {
        flexDirection: "row",
        ...
        children: [
          _jsxs(Text, {
            children: ["enter ", _jsx(Text, { dimColor: true, children: "confirm" })],
          }),
          _jsxs(Text, { children: ["esc ", _jsx(Text, { dimColor: true, children: "cancel" })] }),
        ],
      }),
    ],
  })
    ...
    children: [
      props.header ??
        _jsxs(Box, {
          ...
          flexShrink: 0,
          children: [
            _jsx(Text, { color: theme.warning, children: "!" }),
            _jsx(Text, { color: theme.text, children: props.title }),
          ],
        }),
      props.body,
      _jsx(Box, {
      ...
      _jsxs(Box, {
        ...
        paddingTop: 1,
        children: [
          _jsx(Text, { children: _jsx(Text, { dimColor: true, children: "select" }) }),
          _jsxs(Text, {
            children: ["enter ", _jsx(Text, { dimColor: true, children: "confirm" })],
          }),
        ],
...
export function PermissionPrompt(props) {
  ...
  const session = useMemo(
    () => sync.data.session.find((s) => s.id === props.request.sessionID),
        ...
        props.request.always.length === 1 && props.request.always[0] === "*"
          ...
          : _jsxs(Box, {
              ...
              children: [
                _jsx(Text, {
                  dimColor: true,
                  children: "This will allow the following patterns until OpenCode is restarted",
                }),
                props.request.always.map((pattern) =>
                  _jsxs(Text, { color: theme.text, children: ["- ", pattern] }, pattern),
                ),
              ],
            }),
  ...
  const info = (() => {
      ...
      return {
        ...
        body: filePath
          ? _jsx(Box, {
              ...
              children: _jsx(Text, {
                dimColor: true,
                children: "Path: " + pathFormatter.format(filePath),
              }),
            })
          : null,
      }
    ...
    if (permission === "glob") {
      ...
      return {
        ...
        body: pattern
          ? _jsx(Box, {
              paddingLeft: 1,
              children: _jsx(Text, { dimColor: true, children: "Pattern: " + pattern }),
            })
          : null,
      }
    }
      ...
      return {
        ...
        body: dir
          ? _jsx(Box, {
              ...
              children: _jsx(Text, {
                dimColor: true,
                children: "Path: " + pathFormatter.format(dir),
              }),
            })
          : null,
      }
    ...
    if (permission === "bash") {
      ...
      return {
        ...
        body: command
          ? _jsx(Box, {
              paddingLeft: 1,
              children: _jsx(Text, { color: theme.text, children: "$ " + command }),
            })
          : null,
      }
    }
    if (permission === "task") {
      ...
      return {
        ...
        body: desc
          ? _jsx(Box, {
              paddingLeft: 1,
              children: _jsx(Text, { color: theme.text, children: "> " + desc }),
            })
          : null,
      }
    }
    if (permission === "webfetch") {
      ...
      return {
        ...
        body: url
          ? _jsx(Box, {
              paddingLeft: 1,
              children: _jsx(Text, { dimColor: true, children: "URL: " + url }),
            })
          : null,
      }
    }
    if (permission === "websearch") {
      ...
      return {
        ...
        body: query
          ? _jsx(Box, {
              paddingLeft: 1,
              children: _jsx(Text, { dimColor: true, children: "Query: " + query }),
            })
          : null,
      }
    }
        ...
        body:
          patterns.length > 0
            ? _jsxs(Box, {
                ...
                flexDirection: "column",
                children: [
                  _jsx(Text, { dimColor: true, children: "Patterns" }),
                  patterns.map((p) => _jsxs(Text, { color: theme.text, children: ["- ", p] }, p)),
                ],
              })
            : null,
      }
    ...
    if (permission === "doom_loop") {
      return {
        ...
        body: _jsx(Box, {
          ...
          children: _jsx(Text, {
            dimColor: true,
            children: "This keeps the session running despite repeated failures.",
          }),
        }),
      }
    }
    return {
      ...
      body: _jsx(Box, {
        paddingLeft: 1,
        children: _jsx(Text, { dimColor: true, children: "Tool: " + permission }),
      }),
    }
  })()
  const header = _jsxs(Box, {
    flexDirection: "column",
    children: [
      _jsxs(Box, {
        flexDirection: "row",
        ...
        children: [
          _jsx(Text, { color: theme.warning, children: "!" }),
          _jsx(Text, { color: theme.text, children: "Permission required" }),
        ],
      }),
      _jsxs(Box, {
        flexDirection: "row",
        ...
        flexShrink: 0,
        children: [
          _jsx(Text, { dimColor: true, children: info.icon }),
          _jsx(Text, { color: theme.text, children: info.title }),
        ],
      }),
    ],
  })
