    ...
    children: [
        ...
        ? _jsxs(Box, {
            ...
            children: [
              _jsx(Box, {
                children: _jsxs(Text, {
                  color: theme.text,
                  children: [question?.question, multi ? " (select all that apply)" : ""],
                }),
              }),
              _jsxs(Box, {
                flexDirection: "column",
                        ...
                        children: [
                          _jsxs(Box, {
                            ...
                            children: [
                              ...
                              !multi
                                ? _jsx(Text, { color: theme.success, children: picked ? " v" : "" })
                                : null,
                            ],
                          }),
                          opt.description
                            ? _jsx(Box, {
                                paddingLeft: 3,
                                children: _jsx(Text, { dimColor: true, children: opt.description }),
                              })
                            : null,
                        ],
                      },
                    ...
                    ? _jsxs(Box, {
                        ...
                        children: [
                          ...
                          editing
                            ? _jsx(Box, {
                                ...
                                children: _jsxs(Text, {
                                  ...
                                  children: [
                                    editValue,
                                    _jsx(Text, { color: theme.primary, children: "_" }),
                                  ],
                                }),
                              })
                            : null,
                          !editing && customValue
                            ? _jsx(Box, {
                                paddingLeft: 3,
                                children: _jsx(Text, { dimColor: true, children: customValue }),
                              })
                            : null,
                        ],
                      })
      ...
      isConfirm && !single
        ? _jsxs(Box, {
            ...
            flexDirection: "column",
            children: [
              _jsx(Text, { color: theme.text, children: "Review" }),
              questions.map((q, index) => {
                ...
                return _jsx(
                  Box,
                  {
                    ...
                    children: _jsxs(Text, {
                      children: [
                        _jsxs(Text, { dimColor: true, children: [q.header, ": "] }),
                        _jsx(Text, {
                          color: answered ? theme.text : theme.error,
                          children: answered ? value : "(not answered)",
                        }),
                      ],
                    }),
                  },
      ...
      _jsxs(Box, {
        ...
        children: [
          !single
            ? _jsx(Text, { children: _jsx(Text, { dimColor: true, children: "tab" }) })
            : null,
          !isConfirm
            ? _jsx(Text, { children: _jsx(Text, { dimColor: true, children: "up/down select" }) })
            : null,
          _jsxs(Text, {
            children: [
              "enter",
              ...
              _jsx(Text, {
                dimColor: true,
                children: isConfirm ? "submit" : multi ? "toggle" : single ? "submit" : "confirm",
              }),
            ],
          }),
          _jsxs(Text, { children: ["esc ", _jsx(Text, { dimColor: true, children: "dismiss" })] }),
        ],
      }),
    ],
  })
