      ...
      children: _jsxs(Box, {
        ...
        children: [
          _jsxs(Box, {
            ...
            gap: 1,
            children: [
              _jsx(Text, { bold: true, color: theme.text, children: subagentInfo.label }),
              subagentInfo.total > 0
                ? _jsxs(Text, {
                    dimColor: true,
                    children: ["(", subagentInfo.index, " of ", subagentInfo.total, ")"],
                  })
                : null,
              usage
                ? _jsx(Text, {
                    dimColor: true,
                    children: [usage.context, usage.cost].filter(Boolean).join(" . "),
                  })
                : null,
            ],
          }),
          _jsxs(Box, {
            ...
            children: [
              _jsx(Box, {
                children: _jsxs(Text, {
                  color: theme.text,
                  children: ["Parent ", _jsx(Text, { dimColor: true, children: "p" })],
                }),
              }),
              _jsx(Box, {
                children: _jsxs(Text, {
                  color: theme.text,
                  children: ["Prev ", _jsx(Text, { dimColor: true, children: "[" })],
                }),
              }),
              _jsx(Box, {
                children: _jsxs(Text, {
                  color: theme.text,
                  children: ["Next ", _jsx(Text, { dimColor: true, children: "]" })],
                }),
              }),
            ],
          }),
