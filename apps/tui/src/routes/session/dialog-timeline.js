...
export function DialogTimeline(props) {
  ...
  return _jsxs(Box, {
    ...
    paddingY: 1,
    children: [
      _jsx(Box, { marginBottom: 1, children: _jsx(Text, { bold: true, children: "Timeline" }) }),
      options.length === 0
        ? _jsx(Text, { dimColor: true, children: "No messages found." })
        : options.map((opt, i) =>
            _jsxs(
              Box,
              {
                ...
                children: [
                  ...
                  opt.footer ? _jsxs(Text, { dimColor: true, children: [" ", opt.footer] }) : null,
                ],
              },
              opt.value,
            ),
