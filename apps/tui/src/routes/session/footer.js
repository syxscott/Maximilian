...
export function Footer() {
  ...
  return _jsxs(Box, {
    ...
    flexShrink: 0,
    children: [
      _jsx(Text, { dimColor: true, children: directory }),
      _jsx(Box, {
        gap: 2,
        flexDirection: "row",
        flexShrink: 0,
        children: welcome
          ? _jsxs(Text, {
              children: ["Get started ", _jsx(Text, { dimColor: true, children: "/connect" })],
            })
          : connected
            ? _jsxs(_Fragment, {
                children: [
                  ...
                  _jsxs(Text, {
                    children: [
                      _jsx(Text, {
                        color: lsp.length > 0 ? theme.success : theme.textMuted,
                        children: "*",
                      }),
                      " ",
                      lsp.length,
                  ...
                  mcp > 0
                    ? _jsxs(Text, {
                        children: [
                          _jsx(Text, {
                            color: mcpError ? theme.error : theme.success,
                            children: "@",
                          }),
                          " ",
                          mcp,
                    ...
                    : null,
                  _jsx(Text, { dimColor: true, children: "/status" }),
                ],
              })
            : null,
      }),
