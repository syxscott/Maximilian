...
export function DialogMessage(props) {
    ...
    const options = useMemo(() => [
        {
            ...
            onSelect: () => {
                ...
                if (props.setPrompt) {
                    ...
                    const promptInfo = parts.reduce((agg, part) => {
                        if (part.type === "text") {
                            if (!part.synthetic)
                                agg.input += part.text ?? "";
                        }
    ...
    return (_jsxs(Box, { flexDirection: "column", paddingX: 2, paddingY: 1, children: [_jsx(Box, { marginBottom: 1, children: _jsx(Text, { bold: true, children: "Message Actions" }) }), options.map((opt, i) => (_jsxs(Box, { flexDirection: "row", children: [_jsxs(Text, { color: i === selected ? "green" : undefined, children: [i === selected ? "> " : "  ", opt.title] }), _jsxs(Text, { dimColor: true, children: [" - ", opt.description] })] }, opt.value)))] }));
}
