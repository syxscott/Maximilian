...
function ReasoningHeader({ part, open, toggleable }) {
  ...
  if (!done) {
    return _jsx(Text, {
      children: _jsx(Text, { color: theme.warning, children: "Thinking\u2026" }),
    })
  }
  return _jsxs(Text, {
    color: theme.warning,
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Box, {
        onClick: () => setOpen((v) => !v),
        children: [
          _jsx(ReasoningHeader, { part: part, open: open, toggleable: true }),
          duration > 0
            ? _jsxs(Text, {
      ...
      open
        ? _jsx(Box, {
            paddingLeft: 2,
            marginTop: 1,
            children: _jsx(Text, { color: theme.textMuted, children: content }),
          })
        : null,
    ],
  })
...
function TextPart({ part }) {
  ...
  return _jsx(Box, {
    ...
    marginTop: 1,
    flexShrink: 0,
    children: _jsx(Text, { color: theme.markdownText, children: text }),
  })
}
function GenericTool({ part }) {
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Text, {
        color: theme.text,
        children: ["\u2699 ", part.tool, " ", inputSummary(input)],
      }),
      output
        ? _jsx(Box, { marginTop: 1, children: _jsx(Text, { color: theme.text, children: output }) })
        : null,
    ],
  })
}
...
function UserMessage({ message, parts, pending, onClick }) {
  ...
  return _jsx(Box, {
    ...
    children: _jsxs(Box, {
      ...
      flexDirection: "column",
      children: [
        text ? _jsx(Text, { color: theme.text, children: text }) : null,
        files.length > 0
          ? _jsx(Box, {
              flexDirection: "row",
              gap: 1,
              ...
              children: files.map((file) =>
                _jsxs(
                  Text,
                  { color: theme.textMuted, children: ["[", file.mime, "] ", file.filename] },
                  file.url,
                ),
              ),
            })
          : null,
        queued
          ? _jsx(Text, { color: theme.warning, bold: true, children: "QUEUED" })
          : _jsx(Text, {
              color: theme.textMuted,
              children: formatTodayOrDate(message.time.created),
            }),
        onClick
          ? _jsx(Box, {
              marginTop: 1,
              children: _jsx(Text, {
                color: theme.textMuted,
                children: "(click to view message actions)",
              }),
            })
          : null,
      ],
  ...
  return _jsxs(Box, {
    ...
    children: [
      parts.map((part, index) => {
        if (part.type === "text") return _jsx(TextPart, { part: part }, `${part.type}-${index}`)
        if (part.type === "reasoning")
          return _jsx(ReasoningPart, { part: part }, `${part.type}-${index}`)
        if (part.type === "tool") return _jsx(ToolPart, { part: part }, `${part.type}-${index}`)
        return null
      }),
      message.error && message.error.name !== "MessageAbortedError"
        ? _jsx(Box, {
            ...
            children: _jsx(Text, {
              color: theme.error,
              children: message.error.data?.message ?? message.error.message,
            }),
          })
        : null,
      message.last || final || message.error?.name === "MessageAbortedError"
        ? _jsx(Box, {
            paddingLeft: 3,
            children: _jsxs(Text, {
              children: [
                _jsx(Text, { color: theme.primary, children: "\u25A3 " }),
                _jsx(Text, { color: theme.text, children: message.mode ?? "" }),
                _jsxs(Text, {
                  color: theme.textMuted,
                  children: [
                    " · ",
...
export function Session() {
  ...
  const session = useMemo(
    () => sync.data.session.find((s) => s.id === route.sessionID),
  ...
  if (!session) {
    return _jsx(Box, {
      ...
      children: _jsx(Text, { color: theme.textMuted, children: "Session not found." }),
    })
  }
  const sidebar = sidebarVisible
    ? _jsx(Box, {
        ...
        children: _jsx(Text, { color: theme.textMuted, children: "Sessions sidebar (stub)" }),
      })
    : null
  return _jsxs(Box, {
    flexDirection: "row",
        ...
        children: [
          _jsx(Box, {
            ...
            children: messages.map((message, index) => {
              ...
              return _jsx(
                AssistantMessage,
                { message: message, parts: parts, last: lastAssistant?.id === message.id },
                message.id,
              )
            }),
          }),
          _jsx(Box, {
            flexShrink: 0,
            children: _jsx(Prompt, { ref: bind, sessionID: route.sessionID, onSubmit: toBottom }),
          }),
        ],
      }),
      sidebar,
