...
export function Home() {
  ...
  return _jsxs(HomeSessionDestinationProvider, {
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Box, { flexGrow: 1 }),
          _jsx(Box, { height: 4, flexShrink: 1, children: _jsx(Text, { children: "Maximilian" }) }),
          _jsx(Box, { height: 1, flexShrink: 1 }),
          _jsx(Box, {
            width: "100%",
            zIndex: 1000,
            paddingTop: 1,
            flexShrink: 0,
            children: _jsx(Prompt, { ref: bind, placeholders: placeholder }),
          }),
          _jsx(Box, { flexGrow: 1 }),
        ],
      }),
      _jsx(Box, { width: "100%", flexShrink: 0 }),
    ],
  })
}
