...
export const Prompt = forwardRef(function Prompt(props, forwardedRef) {
  ...
  return _jsxs(Box, {
    ...
    children: [
      props.hint ? _jsx(Box, { children: props.hint }) : null,
      _jsx(Box, {
        borderStyle: "round",
        ...
        children: _jsxs(Box, {
          ...
          children: [
            mode === "shell"
              ? _jsx(Box, {
                  marginRight: 1,
                  children: _jsx(Text, { color: theme.warning, children: "$" }),
                })
              : null,
            _jsx(Box, {
              flexGrow: 1,
              children: visible
                ...
                : _jsx(Text, { color: theme.textMuted, children: input || placeholder }),
            }),
            props.right ? _jsx(Box, { marginLeft: 1, children: props.right }) : null,
          ],
        }),
      }),
              ...
              _jsxs(
                Text,
                {
                  ...
                  children: [
                    ...
                    cmd.name,
                    cmd.description
                      ? _jsxs(Text, { color: theme.textMuted, children: [" ", cmd.description] })
                      : null,
                  ],
                },
                cmd.name,
      ...
      status.type !== "idle"
        ? _jsx(Box, {
            marginTop: 1,
            children: _jsxs(Text, { color: theme.warning, children: ["Session: ", status.type] }),
          })
        : null,
    ],
  })
