...
export const API_PATHS = [
  ...
  "GET /executions",
  "GET /executions/role/{role}",
  "GET /executions/workspace/{workspaceId}",
  "GET /executions/{id}",
  "GET /flags",
  "GET /flags/{name}",
  "GET /gov/pending",
...
/** Number of routes in the backend contract: 95. */
export const API_PATH_COUNT = 95
