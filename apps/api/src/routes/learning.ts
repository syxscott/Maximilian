...
export const learningStatusRoute = createRoute({
  ...
  responses: {
    200: {
      ...
      description: "Aggregate learning status",
    },
  },
})
...
export const learningAgentsRoute = createRoute({
  ...
  responses: {
    200: {
      content: { "application/json": { schema: z.unknown() } },
      description: "Per-role agent summary",
    },
  },
})
...
export const learningFailurePatternsRoute = createRoute({
  ...
  responses: {
    200: {
      content: { "application/json": { schema: z.unknown() } },
      description: "Mined failure patterns",
    },
  },
})
...
export const learningMineFailurePatternsRoute = createRoute({
  ...
  responses: {
    200: {
      content: { "application/json": { schema: z.unknown() } },
      description: "Freshly mined patterns",
    },
    500: {
      content: { "application/json": { schema: ErrorSchema } },
      description: "Failure analyzer not wired",
    },
  },
})
