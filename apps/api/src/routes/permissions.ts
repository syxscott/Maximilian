...
export const getPermissionsRoute = createRoute({
  ...
  tags: ["permissions"],
  responses: {
    200: { content: { "application/json": { schema: PermissionsConfigSchema } }, description: "Current permissions config" },
...
export const putPermissionsRoute = createRoute({
  ...
  responses: {
    200: { content: { "application/json": { schema: PermissionsConfigSchema } }, description: "Persisted config" },
...
export const resolvePermissionRoute = createRoute({
  ...
  responses: {
    200: { content: { "application/json": { schema: ResolveResponseSchema } }, description: "Decision for the given tool/input" },
    400: { content: { "application/json": { schema: ErrorSchema } }, description: "Invalid tool or body" },
    500: { content: { "application/json": { schema: ErrorSchema } }, description: "Internal error" },
  },
});
...
export const testPermissionRoute = createRoute({
  ...
  responses: {
    200: { content: { "application/json": { schema: TestResponseSchema } }, description: "Pattern match result" },
    400: { content: { "application/json": { schema: ErrorSchema } }, description: "Missing pattern or value" },
  },
});
...
export const resetPermissionsRoute = createRoute({
  ...
  tags: ["permissions"],
  responses: {
    200: { content: { "application/json": { schema: PermissionsConfigSchema } }, description: "Restored default config" },
    500: { content: { "application/json": { schema: ErrorSchema } }, description: "Internal error" },
  },
});
...
export const answerPermissionRoute = createRoute({
  ...
  responses: {
    200: { content: { "application/json": { schema: AnswerResponseSchema } }, description: "Decision applied" },
...
export const auditPermissionsRoute = createRoute({
  ...
  responses: {
    200: { content: { "application/json": { schema: PermissionAuditResponseSchema } }, description: "Audit log entries" },
    503: { content: { "application/json": { schema: ErrorSchema } }, description: "Runtime unavailable" },
  },
});

export function permissionsRoutes(deps: PermissionsRoutesDeps = {}) {
  const { rootDir, runtime } = deps;
  return {
