...
export const listCapabilitiesRoute = createRoute({
  ...
  responses: {
    200: {
      ...
      description: "Paginated capabilities",
    },
  },
})
...
export const listProposalsRoute = createRoute({
  ...
  responses: {
    200: {
      content: { "application/json": { schema: z.unknown() } },
      description: "Capability proposals",
    },
  },
})
  ...
  request: {
    body: {
      content: {
        "application/json": {
          schema: z.object({
            graphs: z.array(z.unknown()).optional(),
            capabilities: z.array(z.unknown()).optional(),
            blueprints: z.array(z.unknown()).optional(),
          }),
        },
      },
    },
...
export const getGovernanceConfigRoute = createRoute({
  ...
  responses: {
    200: {
      content: { "application/json": { schema: GovernanceConfigSchema } },
      description: "Governance config",
    },
  },
})
...
export const putGovernanceConfigRoute = createRoute({
  ...
  responses: {
    200: {
      content: {
        "application/json": {
          schema: z.object({ ok: z.boolean(), config: GovernanceConfigSchema }),
        },
      },
