...
export const listAgentsRoute = createRoute({
  ...
  responses: {
    200: {
      ...
      description: "Paginated agent profiles",
    },
  },
})
...
export const leaderboardForRoleRoute = createRoute({
  ...
  responses: {
    200: {
      ...
      description: "Per-role leaderboard",
    },
    400: { content: { "application/json": { schema: ErrorSchema } }, description: "Missing role" },
  },
})
...
export const listDecisionsRoute = createRoute({
  ...
  responses: {
    200: {
      content: { "application/json": { schema: z.unknown() } },
      description: "Evolution decisions",
    },
    400: { content: { "application/json": { schema: ErrorSchema } }, description: "Missing role" },
  },
})
...
export const recordFeedbackRoute = createRoute({
  ...
  responses: {
    200: {
      content: {
        "application/json": { schema: z.object({ ok: z.boolean(), totalFeedback: z.number() }) },
      },
...
export const triggerEvolveRoute = createRoute({
  ...
  responses: {
    200: {
      content: { "application/json": { schema: z.unknown() } },
      description: "Evolution decision",
    },
    400: { content: { "application/json": { schema: ErrorSchema } }, description: "Missing role" },
    404: {
      content: { "application/json": { schema: ErrorSchema } },
      description: "No profile/manifest for role",
    },
  },
})
