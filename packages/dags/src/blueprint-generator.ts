...
export class BlueprintGenerator {
  ...
  async generate(capabilityIds: string[], options: GeneratorOptions): Promise<AgentBlueprint[]> {
...
function synthesize(role: string, caps: Capability[], options: GeneratorOptions): AgentBlueprint {
...
function mergeConstraints(
  a: AgentBlueprint["constraints"],
  b: Capability["defaultConstraints"],
): AgentBlueprint["constraints"] {
  return {
