...
import type { OrganizationSnapshot, CapabilityRecord } from "./types.js"
 ...
 */
export function scoreProposal(proposal: Proposal, sim: SimulationDelta): DecisionScore {
  ...
  const utility = round2(qualityGain - latencyPenalty - costPenalty - riskPenalty)
 ...
 */
export function fromAgentChange(decision: {
...
export function fromTeamHint(hint: {
  id: string
  suggestions: Array<{
    type: string
    targetRole?: string
