...
export class CapabilityDiscoveryEngine {
  ...
  private static readonly GAP_PATTERNS: Array<{
    re: RegExp
    capabilityId: string
    displayName: string
  }> = [
    {
      re: /\b(mobile|ios|android|swift|kotlin|flutter)\b/i,
      capabilityId: "mobile_app_development",
      displayName: "Mobile App Development",
    },
    {
      re: /\b(blockchain|web3|solidity|smart contract)\b/i,
      capabilityId: "blockchain_development",
      displayName: "Blockchain Development",
    },
    {
      re: /\b(game|godot|unity|unreal)\b/i,
      capabilityId: "game_development",
      displayName: "Game Development",
    },
    {
      re: /\b(data science|pandas|numpy|jupyter)\b/i,
      capabilityId: "data_science",
      displayName: "Data Science",
    },
    {
      re: /\b(nlp|gpt|llm|transformer|embedding)\b/i,
      capabilityId: "llm_engineering",
      displayName: "LLM Engineering",
    },
    {
      re: /\b(graphql|grpc|websocket)\b/i,
      capabilityId: "api_engineering",
      displayName: "API Engineering",
    },
    { re: /\b(cicd|jenkins|github actions)\b/i, capabilityId: "ci_cd", displayName: "CI/CD" },
    {
      re: /\b(seo|marketing|landing page)\b/i,
      capabilityId: "marketing_engineering",
      displayName: "Marketing Engineering",
    },
    {
      re: /\b(design|figma|ux|wireframe)\b/i,
      capabilityId: "design_engineering",
      displayName: "Design Engineering",
    },
    // Phase 7 — added for closed-loop E2E scenario (data pipeline projects).
    {
      re: /\b(data pipeline|etl|elt|data warehouse|olap|data ingestion|airflow|spark)\b/i,
      capabilityId: "data_pipeline",
  ...
  async discover(
    ...
    const candidateMap = new Map<string, { displayName: string; signals: DiscoverySignal[] }>()
