...
const CAPABILITY_TABLE: Record<
  string,
  {
    strengths: ModelProfile["strengths"]
    costTier: ModelProfile["costTier"]
    speedTier: ModelProfile["speedTier"]
  }
> = {
...
const DEFAULT_CAPABILITIES = {
  strengths: ["general"] as ModelProfile["strengths"],
...
export function bootstrapModelRouting(
  ...
  const embeddingRouter = new EmbeddingRouter(router, {
    embed: options.embedder,
  } as EmbeddingRouterOptions)
