...
export const Switch = React.forwardRef<React.ElementRef<typeof SwitchPrimitive.Root>, SwitchProps>(
  ({ className, children, hideLabel, ...props }, ref) => (
    <SwitchPrimitive.Root ref={ref} className={cn(className)} data-component="switch" {...props}>
      <input
        type="checkbox"
      ...
      />
      {children ? (
        <LabelPrimitive.Root data-slot="switch-label" className={cn(hideLabel && "sr-only")}>
          {children}
        </LabelPrimitive.Root>
      ) : null}
