...
import { resolveCredentialLeaseEndpoint } from "./endpoints.js"
import { startCredentialLeaseServer, type CredentialLeaseServer } from "./node-server.js"
...
function isUsableLease(lease: AccessTokenLease, minValidityMs: number, nowMs: number): boolean {
