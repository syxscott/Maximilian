...
export type CredentialLeaseSuccessResult =
  CredentialLeaseStatusResult | CredentialLeaseResult | CredentialLeaseUnauthorizedResult
...
export type CredentialLeaseResponse =
  CredentialLeaseSuccessResponse | CredentialLeaseFailureResponse
...
function parseUnauthorizedResult(
