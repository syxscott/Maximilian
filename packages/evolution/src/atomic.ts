 ...
 *
 * This is a local copy of `packages/workspace/src/atomic.ts`. The two
 * implementations are kept in sync intentionally — each package owns its
 * persistence files and we don't want a `workspace` dependency pulled in
