...
import { DEFAULT_PERMISSIONS, resolvePermission, type Permissions } from "../src/permission"
...
describe("OpencodePermissionTranslator with mocked SSE events", () => {
  ...
  it("permission.v2.replied 'always' round-trips into a persisted Maximilian rule", () => {
    ...
    const translated = t.fromOpencodePermissionReply(repliedEvent.reply, askedEvent.save)
